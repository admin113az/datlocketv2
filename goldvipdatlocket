#!name = Datlocket_VIP
#!desc = Unlock Locket Gold + Spotify + YouTube No Ads + SoundCloud + Wink
#!author = Datlocket_VIP
#!homepage = https://github.com/linkhot24s
#!icon = https://raw.githubusercontent.com/Koolson/Qure/master/IconSet/Color/YouTube.png

# ==============================
# Rule (YouTube QUIC block)
# ==============================
[Rule]
...
# ===== Locket (RevenueCat) =====
revenuecat = type=http-response,pattern=^https:\/\/api\.revenuecat\.com\/.+\/(receipts$|subscribers\/[^/]+$),requires-body=true,max-size=-1,timeout=60,script-path=https://raw.githubusercontent.com/linkhot24s/datlocket/main/Locket_Datlocket.js
...
# ===== SoundCloud =====
SoundCloudGoPlus = type=http-response,pattern=https://api-mobile.soundcloud.com/configuration/ios,requires-body=1,script-path=https://raw.githubusercontent.com/duyvinh09/Module_IOS/refs/heads/main/js/SoundCloudGoPlus.js
